          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 p-0 footer-left">
                <p class="mb-0">Copyright © <?=date('Y')?> Hospital. All rights reserved.</p>
              </div>
...
<!-- Mirrored from admin.pixelstrap.com/tivo/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Mar 2024 10:38:58 GMT -->
</html>