            ...
            <div class="card-body">
              ...
              <div class="greeting-user">
                <div class="profile-vector">
                  ...
                  </ul><img class="img-fluid" src="<?=IMG?>dashboard/default/profile.png" alt="">
                  <ul class="vector-image">
                    <li> <img src="<?=IMG?>dashboard/default/ribbon1.png" alt=""></li>
                    <li> <img src="<?=IMG?>dashboard/default/ribbon3.png" alt=""></li>
                    <li> <img src="<?=IMG?>dashboard/default/ribbon4.png" alt=""></li>
                    <li> <img src="<?=IMG?>dashboard/default/ribbon5.png" alt=""></li>
                    <li> <img src="<?=IMG?>dashboard/default/ribbon6.png" alt=""></li>
                    <li> <img src="<?=IMG?>dashboard/default/ribbon7.png" alt=""></li>
                  </ul>
                </div>
                ...
                <div><span class="badge badge-primary">Your 5</span><span class="font-primary f-12 middle f-w-500 ms-2">
                    Task Is Pending</span></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card total-revenue overflow-hidden">
            ...
            <div class="card-body p-0">
              ...
              <div class="code-box-copy">
                ...
                <pre>
                        <code class="language-html" id="revenue">&lt;div class="card total-revenue overflow-hidden"&gt;
                            &lt;div class="card-header"&gt;
                              &lt;div class="d-flex justify-content-between"&gt;
                                &lt;div class="flex-grow-1"&gt;
            ...
            <div class="card-body">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#investment"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                        <code class="language-html" id="investment">&lt;div class="card total-investment"&gt;
                            &lt;div class="card-header pb-0"&gt;
                              &lt;div class="d-flex justify-content-between"&gt;
                                &lt;div class="flex-grow-1"&gt;
            ...
            <div class="card-body">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#users"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                        <code class="language-html" id="users">&lt;div class="card our-user"&gt;
                            &lt;div class="card-header pb-0"&gt;
                              &lt;div class="d-flex justify-content-between"&gt;
                                &lt;div class="flex-grow-1"&gt;
            ...
            <div class="card-body p-0">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#earning"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                        <code class="language-html" id="earning">&lt;div class="card our-earning"&gt;
                            &lt;div class="card-header pb-0"&gt;
                              &lt;div class="d-flex justify-content-between"&gt;
                                &lt;div class="flex-grow-1"&gt;
            ...
            <div class="card-body">
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex"><img class="img-fluid align-top circle"
                            src="<?=IMG?>dashboard/default/01.png" alt="">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex"><img class="img-fluid align-top circle"
                            src="<?=IMG?>dashboard/default/02.png" alt="">
                      ...
                      <td class="text-end">
                        <button class="btn btn-secondary" type="button"
                          onclick="document.location='user-cards.html'">Done<i class="fa fa-check-circle"></i></button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="d-flex"><img class="img-fluid align-top circle"
                            src="<?=IMG?>dashboard/default/03.png" alt="">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex"><img class="img-fluid align-top circle"
                            src="<?=IMG?>dashboard/default/04.png" alt="">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex"><img class="img-fluid align-top circle"
                            src="<?=IMG?>dashboard/default/05.png" alt="">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#appoinment"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                        <code class="language-html" id="appoinment">&lt;div class="card appointment-detail"&gt;
                              &lt;div class="card-header pb-0"&gt;
                                &lt;div class="d-flex justify-content-between"&gt;
                                  &lt;div class="flex-grow-1"&gt;
                                  ...
                                  &lt;table class="table"&gt;
                                    &lt;tbody&gt;
                                      &lt;tr&gt;
                                        &lt;td&gt;
                                          &lt;div class="d-flex"&gt;
                                            &lt;img class="img-fluid align-top circle" src="<?=IMG?>dashboard/default/01.png" alt=""&gt;&lt;/img&gt;
                                            &lt;div class="flex-grow-1"&gt;
                                      ...
                                      &lt;tr&gt;
                                        &lt;td&gt;
                                          &lt;div class="d-flex"&gt;
                                            &lt;img class="img-fluid align-top circle" src="<?=IMG?>dashboard/default/02.png" alt=""&gt;&lt;/img&gt;
                                            &lt;div class="flex-grow-1"&gt;
                                              &lt;a href="user-profile.html"&gt;
                                      ...
                                      &lt;tr&gt;
                                        &lt;td&gt;
                                          &lt;div class="d-flex"&gt;
                                            &lt;img class="img-fluid align-top circle" src="<?=IMG?>dashboard/default/03.png" alt=""&gt;&lt;/img&gt;
                                            &lt;div class="flex-grow-1"&gt;
                                              &lt;a href="user-profile.html"&gt;
                                      ...
                                      &lt;tr&gt;
                                        &lt;td&gt;
                                          &lt;div class="d-flex"&gt;
                                            &lt;img class="img-fluid align-top circle" src="<?=IMG?>dashboard/default/04.png" alt=""&gt;&lt;/img&gt;
                                            &lt;div class="flex-grow-1"&gt;
                                              &lt;a href="user-profile.html"&gt;
                                      ...
                                      &lt;tr&gt;
                                        &lt;td&gt;
                                          &lt;div class="d-flex"&gt;
                                            &lt;img class="img-fluid align-top circle" src="<?=IMG?>dashboard/default/05.png" alt=""&gt;&lt;/img&gt;
                                            &lt;div class="flex-grow-1"&gt;
                                              &lt;a href="user-profile.html"&gt;
            ...
            <div class="card-body">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#country"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                        <code class="language-html" id="country">&lt;div class="card use-country"&gt;
                              &lt;div class="card-header pb-0"&gt;
                                &lt;div class="d-flex justify-content-between"&gt;
                                  &lt;div class="flex-grow-1"&gt;
            ...
            <div class="card-body pb-0">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#growth"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                        <code class="language-html" id="growth">&lt;div class="card total-growth"&gt;
                              &lt;div class="card-header pb-0"&gt;
                                &lt;div class="d-flex justify-content-between"&gt;
                                  &lt;div class="flex-grow-1"&gt;
            ...
            <div class="card-body">
              <div class="activity-timeline">
                ...
                <div class="d-flex align-items-start">
                  ...
                  <div class="flex-grow-1"><span class="f-w-600 d-block">Jihan Doe just like your product</span>
                    <p class="mb-0">Design and style should work toward making you look good and feel good without lot
                      of effort.</p>
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#activity"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                  <code class="language-html" id="activity">&lt;div class="card"&gt;
                        &lt;div class="card-header pb-0"&gt;
                          &lt;div class="d-flex justify-content-between"&gt;
                            &lt;div class="flex-grow-1"&gt;
        ...
        <div class="col-xl-4 proorder box-col-33">
          <div class="card user-chat">
            <div class="card-header pb-0">
              <div class="d-flex justify-content-between">
                <div class="flex-grow-1">
                  <p class="square-after f-w-600 header-text-primary">Chat With Our Users<i class="fa fa-circle"> </i>
                  </p>
                  <h4>Chat</h4>
                </div>
                <div class="setting-list">
            ...
            <div class="card-body chat-box">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#chat"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                  <code class="language-html" id="chat">
                      &lt;div class="card user-chat"&gt;
                      &lt;div class="card-header pb-0"&gt;
                        &lt;div class="d-flex justify-content-between"&gt;
                          &lt;div class="flex-grow-1"&gt;
            ...
            <div class="card-body">
              <div class="activity-timeline todo-timeline">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div class="d-flex mt-0"><img class="img-fluid img-30" src="<?=IMG?>dashboard/default/todo.png"
                        alt="">
                ...
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <p class="mb-0">Design and style should work making you look good and feel good without lot of
                      effort.</p>
                  </div>
                </div>
                <div class="d-flex">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#to-do"><i
                    class="icofont icofont-copy-alt"></i></button>
                <pre>
                  <code class="language-html" id="to-do">&lt;div class="card our-todolist"&gt;
                      &lt;div class="card-header pb-0"&gt;
                        &lt;div class="d-flex justify-content-between"&gt;
                          &lt;div class="flex-grow-1"&gt;
                          ...
                          &lt;div class="d-flex"&gt;
                            ...
                            &lt;div class="flex-grow-1"&gt;
                              ...
                              &lt;div class="d-flex mt-0"&gt;
                                &lt;img class="img-fluid img-30" src="<?=IMG?>dashboard/default/todo.png" alt=""/&gt;
                                &lt;div class="flex-grow-1"&gt;
